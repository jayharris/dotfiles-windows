...
# General: Let apps use my advertising ID for experiences across apps: Allow: 1, Disallow: 0
Set-ItemProperty "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\AdvertisingInfo" "Enabled" 0

# General: Turn on SmartScreen Filter to check web content (URLs) that Windows Store apps use: Allow: 1, Disallow: 0
Set-ItemProperty "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\AppHost" "EnableWebContentEvaluation" 0

# General: Keylogging: Send Microsoft info about how I write...: Allow: 1, Disallow: 0
# Disabled when Telemetry is set to Basic
Set-ItemProperty "HKCU:\SOFTWARE\Microsoft\Input\TIPC" "Enabled" 0

# General: Let websites provide locally relevant content by accessing my language list: Allow: 0, Disallow 1
Set-ItemProperty "HKCU:\Control Panel\International\User Profile" "HttpAcceptLanguageOptOut" 1

# General: SmartGlass: Let apps on other devices open apps on this device: Allow: 1, Disallow: 0
Set-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\SmartGlass" "UserAuthPolicy" 0

# General: SmartGlass: Let apps on other devices use Bluetooth to open apps on this device: Allow: 1, Disallow: 0
...
# Account Info: Let apps access name, picture, and other account info: Allow, Deny
...
# Contacts: Let apps access contacts: Allow, Deny
...
# Calendar: Let apps access calendar: Allow, Deny
...
# Call History: Let apps access call history: Allow, Deny
...
# Email: Let apps read and send email: Allow, Deny
...
# Messaging: Let apps read or send messages (text or MMS): Allow, Deny
...
# Redios: Let apps control radios (like Bluetooth): Allow, Deny
...
# Feedback: Windows should ask for my feedback: Never
